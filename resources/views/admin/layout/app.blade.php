...
<body class="hold-transition sidebar-mini layout-fixed">
        ...
        <div class="wrapper">
            ...
            <nav class="main-header navbar navbar-expand navbar-white navbar-light">
                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    <ul class="navbar-nav">
                        <li class="nav-item d-none d-sm-inline-block">
                            <a href="{{ '/dashboard' }}" class="nav-link" href="{{ route('logout') }}"
                            ...
                            <li class="nav-item menu-open">
                                ...
                                <ul class="nav nav-treeview">
                                    <li class="nav-item menu">
                                        ...
                                        <ul class="nav nav-treeview">
                                            <li class="nav-item">
                                                <a href="{{ url('dashboard/bookedTable') }}" class="nav-link">
                                                    <i class="far fa-circle nav-icon"></i>
                                                    <p> Booked table </p>
                                                </a>
                                            </li>
                                            <li class="nav-item">
                                                <a href="{{ url('dashboard/confirmedBookTable') }}" class="nav-link">
                                                    <i class="far fa-circle nav-icon"></i>
                                    ...
                                    <li class="nav-item menu">
                                        ...
                                        <ul class="nav nav-treeview">
                                            <li class="nav-item">
                                                <a href="{{ url('dashboard/menuCategory') }}" class="nav-link">
                                                    <i class="far fa-circle nav-icon"></i>
                                                    <p>Categories </p>
                                                </a>
                                            </li>
                                            <li class="nav-item">
                                                <a href="{{ url('dashboard/menuItem') }}" class="nav-link">
                                                    <i class="far fa-circle nav-icon"></i>
                                                    <p>Items </p>
                                                </a>
                                            </li>
                                    ...
                                    <li class="nav-item menu">
                                        ...
                                        <ul class="nav nav-treeview">
                                            ...
                                            <li class="nav-item">
                                                <a href="{{ url('dashboard/message') }}" class="nav-link">
                                                    <i class="far fa-circle nav-icon"></i>
                                                    <p>Mail </p>
                                                </a>
                                            </li>
                                    ...
                                    @if (Auth::user()->role->name == 'admin')
                                        ...
                                        <li class="nav-item menu">
                                            ...
                                            <ul class="nav nav-treeview">
                                                <li class="nav-item">
                                                    <a href="{{ url('dashboard/cover') }}" class="nav-link">
                                                        <i class="far fa-circle nav-icon"></i>
                                                        <p>Cover </p>
                                                    </a>
                                                </li>
                                                <li class="nav-item">
                                                    <a href="{{ url('dashboard/chefs') }}" class="nav-link">
                                                        <i class="far fa-circle nav-icon"></i>
                                                        <p>Chefs </p>
                                                    </a>
                                                </li>
                                                ...
                                                <li class="nav-item">
                                                    <a href="{{ url('dashboard/why_choose_yummy') }}"
                                                        class="nav-link">
                                                        <i class="far fa-circle nav-icon"></i>
                                                ...
                                                <li class="nav-item">
                                                    <a href="{{ url('dashboard/stats') }}" class="nav-link">
                                                        <i class="far fa-circle nav-icon"></i>
                                                        <p>Stats </p>
                                                    </a>
                                                ...
                                                <li class="nav-item">
                                                    <a href="{{ url('dashboard/gallery') }}" class="nav-link">
                                                        <i class="far fa-circle nav-icon"></i>
                                                        <p>Gallery </p>
                                                    </a>
                                                </li>
  ...
  z-index: $zindex-main-footer;">
            ...
            @elseif (Auth::user()->role->name == 'guest')
                <button type="button" class="btn btn-block btn-danger btn-lg"><a class="nav-link"
                        style="color: black" href="{{ route('logout') }}"
                        onclick="event.preventDefault();document.getElementById('logout-form').submit();"><i
                            class="bx bx-log-out"></i> Return to login Page </a></button>
