...
<div class="container w-50">
    <form action="{{ url("dashboard/events/edit-events/$events->id") }}" method="POST" enctype="multipart/form-data" >
        @csrf
        @method('PUT')
<div class="card-body">
    ...
    <div class="form-group"><img src="{{asset("storage/$events->image") }}" width="100px" alt=""></div>
